...
namespace DuneFlame.Infrastructure.Migrations
{
    ...
    [Migration("20260518111758_AddOrderChannelAndShippingMethod")]
    partial class AddOrderChannelAndShippingMethod
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.AboutSectionTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AboutSectionTranslations");
                });
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.Brand", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.BrandTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.Category", b =>
                {
                    ...
                    b.Property<bool>("IsCoffeeCategory")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.CityTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.CountryTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.CustomerBasket", b =>
                {
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.FlavourNote", b =>
                {
                    ...
                    b.Property<Guid>("ProductCoffeeProfileId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ProductCoffeeProfileId");
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.GrindTypeTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("GrindTypeTranslations");
                });
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.OrderItem", b =>
                {
                    ...
                    b.Property<string>("SelectedGrindTypeName")
                        .HasColumnType("text");

                    b.Property<string>("SelectedRoastLevelName")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.OriginTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.ProductAttribute", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.ProductAttributeTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.ProductAttributeValue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.ProductAttributeValueTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.ProductCoffeeProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.ProductVariantOption", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.RoastLevelTranslation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RoastLevelTranslations");
                });
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.WholesaleLead", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("GrindTypeProductCoffeeProfile", b =>
                {
                    ...
                    b.HasKey("GrindTypesId", "ProfilesId");

                    b.HasIndex("ProfilesId");

                    b.ToTable("ProductCoffeeProfileGrindTypes", (string)null);
                });
            ...
            modelBuilder.Entity("ProductCoffeeProfileRoastLevelEntity", b =>
                {
                    b.Property<Guid>("ProfilesId")
                        .HasColumnType("uuid");
                    ...
                    b.HasKey("ProfilesId", "RoastLevelsId");

                    b.HasIndex("RoastLevelsId");

                    b.ToTable("ProductCoffeeProfileRoastLevels", (string)null);
                });

            modelBuilder.Entity("DuneFlame.Domain.Entities.AboutSectionTranslation", b =>
                {
                    b.HasOne("DuneFlame.Domain.Entities.AboutSection", "AboutSection")
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.BrandTranslation", b =>
                {
                    b.HasOne("DuneFlame.Domain.Entities.Brand", "Brand")
                        .WithMany("Translations")
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.Category", b =>
                {
                    b.HasOne("DuneFlame.Domain.Entities.Category", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.CityTranslation", b =>
                {
                    b.HasOne("DuneFlame.Domain.Entities.City", "City")
                        .WithMany("Translations")
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.FlavourNote", b =>
                {
                    b.HasOne("DuneFlame.Domain.Entities.ProductCoffeeProfile", "ProductCoffeeProfile")
                        .WithMany("FlavourNotes")
                        .HasForeignKey("ProductCoffeeProfileId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ProductCoffeeProfile");
                });
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.ProductAttributeTranslation", b =>
                {
                    b.HasOne("DuneFlame.Domain.Entities.ProductAttribute", "ProductAttribute")
                        .WithMany("Translations")
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.ProductAttributeValueTranslation", b =>
                {
                    b.HasOne("DuneFlame.Domain.Entities.ProductAttributeValue", "ProductAttributeValue")
                        .WithMany("Translations")
            ...
            modelBuilder.Entity("DuneFlame.Domain.Entities.ProductCoffeeProfile", b =>
                {
                    ...
                    b.HasOne("DuneFlame.Domain.Entities.Product", "Product")
                        .WithOne("CoffeeProfile")
                        .HasForeignKey("DuneFlame.Domain.Entities.ProductCoffeeProfile", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("GrindTypeProductCoffeeProfile", b =>
                {
                    ...
                    b.HasOne("DuneFlame.Domain.Entities.ProductCoffeeProfile", null)
                        .WithMany()
