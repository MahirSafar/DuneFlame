...
public interface IRewardService
{
    ...
    Task<List<RewardTransactionDto>> GetTransactionsAsync(Guid userId, string languageCode = "en");
    Task EarnPointsAsync(Guid userId, Guid orderId, decimal amount, bool saveChanges = true);
    Task RedeemPointsAsync(Guid userId, decimal amount, Guid orderId, bool saveChanges = true);
